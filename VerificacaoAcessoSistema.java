...
public class VerificacaoAcessoSistema {    
    public static void main(String[] args) {    
        ...
        boolean permissaoValida = nivelPermissao >= nivelPermissaoMinimo && nivelPermissao <= nivelPermissaoMaximo;    // Se o nivel de permissão for maior e igual que niver de permissão mínimo e nivel de permisão for menor e igual ao nivel maximo a permissão é válida
